...
namespace OrangLauncher
{
    ...
    public partial class MainWindow
    {
        ...
        private void RefreshContentInstances()
        {
            ...
            _contentDefaultSetup = null; // redetect .minecraft on next use
        ...
        private async Task LoadContentIconAsync(ContentItemVm vm, string? iconUrl)
        {
            ...
            // Decode in Core via SkiaSharp WebP icons render blank.
        ...
        private void ContentDetailsButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                new ModDetailsWindow(vm.Slug, vm.Title, vm.Description, vm.IconUrl, vm.ProjectType,
                    installPath, targetVersion ?? "", vm.ProjectType == "mod" ? targetLoader ?? "" : "").Activate();
            }
            catch (Exception ex)
            {
